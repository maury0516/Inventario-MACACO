    ...
    public partial class SubCategory : System.Web.UI.Page
    {
        ...
        void Permisos(int id_rol)
        {
            try
            {
                ...
                while (reader.Read())
                {
                    foreach (GridViewRow fila in gvSubCat.Rows)
                    //while (reader.Read())
                    {
                        switch (reader[0].ToString())
                        {
                            ...
                            case "Read":
                                ...
                                {
                                    btn1.Visible = true;
                                    gvSubCat.Visible = true;
                                }
                                else
                                {
                                    btn1.Visible = true;
                                    gvSubCat.Visible = false;
                                }
                                break;
                            case "Update":
        ...
        void Datos()
        {
            try
            {
                SqlCommand cmd = new SqlCommand("sp_SelSubCategory", con);
                cmd.CommandType = CommandType.StoredProcedure;
                con.Open();
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                da.Fill(dt);
                gvSubCat.DataSource = dt;
                gvSubCat.DataBind();
                con.Close();
            }
            catch (Exception)
        ...
        {
            Response.Redirect("CRUDSubCategorias.aspx?op=C");
        }
        protected void Btnread_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("CRUDSubCategorias.aspx?id=" + id + "&op=R");
        }
        ...
        protected void Btnupdate_Click(object sender, EventArgs e)
        {
            ...
            GridViewRow selectedrow = (GridViewRow)btnConsultar.NamingContainer;
            id = selectedrow.Cells[1].Text;
            Response.Redirect("CRUDSubCategorias.aspx?id=" + id + "&op=U");
        }
        ...
        protected void Btndelete_Click(object sender, EventArgs e)
        {
            ...
            GridViewRow selectedrow = (GridViewRow)btnConsultar.NamingContainer;
            id = selectedrow.Cells[1].Text;
            Response.Redirect("CRUDSubCategorias.aspx?id=" + id + "&op=D");
        }
        ...
        protected void Btnhabilitar_Click(object sender, EventArgs e)
        {
            ...
            GridViewRow selectedrow = (GridViewRow)btnConsultar.NamingContainer;
            id = selectedrow.Cells[1].Text;
            Response.Redirect("CRUDSubCategorias.aspx?id=" + id + "&op=H");
        }
        protected void BtnInhabilitados_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SubCategoryDeshabilitadas", con);
                ...
                SqlCommand cmd1 = new SqlCommand("SubCategoryDeshabilitadas", con);
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
                con.Open();
