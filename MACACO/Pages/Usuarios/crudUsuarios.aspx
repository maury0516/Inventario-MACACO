    ...
    <div class="mx-auto" style="width: 500px">
        ...
        <div>
            ...
            <div class="mb-3">
                ...
                <asp:TextBox runat="server" ID="nombre" CssClass="form-control" MaxLength="100"></asp:TextBox>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <asp:TextBox runat="server" ID="password" CssClass="form-control" Type="password" MaxLength="50"></asp:TextBox>
