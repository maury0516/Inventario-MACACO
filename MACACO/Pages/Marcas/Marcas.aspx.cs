    ...
    public partial class Marcas : System.Web.UI.Page
    {
        ...
        void Permisos(int id_rol)
        {
            try
            {
                ...
                while (reader.Read())
                {
                    foreach (GridViewRow fila in gvMarca.Rows)
                    //while (reader.Read())
                    {
                        switch (reader[0].ToString())
                        {
                            ...
                            case "Read":
                                ...
                                {
                                    btn1.Visible = true;
                                    gvMarca.Visible = true;
                                }
                                else
                                {
                                    btn1.Visible = true;
                                    gvMarca.Visible = false;
                                }
                                break;
                            case "Update":
        ...
        void Datos()
        {
            try
            {
                SqlCommand cmd = new SqlCommand("sp_SelMarca", con);
                cmd.CommandType = CommandType.StoredProcedure;
                con.Open();
        ...
        {
            Response.Redirect("CRUDMarca.aspx?op=C");
        }
        protected void Btnread_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("CRUDMarca.aspx?id=" + id + "&op=R");
        }
        ...
        protected void Btnupdate_Click(object sender, EventArgs e)
        {
            ...
            GridViewRow selectedrow = (GridViewRow)btnConsultar.NamingContainer;
            id = selectedrow.Cells[1].Text;
            Response.Redirect("CRUDMarca.aspx?id=" + id + "&op=U");
        }
        ...
        protected void Btndelete_Click(object sender, EventArgs e)
        {
            ...
            GridViewRow selectedrow = (GridViewRow)btnConsultar.NamingContainer;
            id = selectedrow.Cells[1].Text;
            Response.Redirect("CRUDMarca.aspx?id=" + id + "&op=D");
        }
        ...
        protected void Btnhabilitar_Click(object sender, EventArgs e)
        {
            ...
            GridViewRow selectedrow = (GridViewRow)btnConsultar.NamingContainer;
            id = selectedrow.Cells[1].Text;
            Response.Redirect("CRUDMarca.aspx?id=" + id + "&op=H");
        }
        protected void BtnInhabilitados_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("marcasDeshabilitadas", con);
                ...
                SqlCommand cmd1 = new SqlCommand("marcasDeshabilitadas", con);
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
                con.Open();
