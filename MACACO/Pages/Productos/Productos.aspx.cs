...
{
    public partial class IndexProductos : System.Web.UI.Page
    {
        int id_rol = 0;
        ...
        void Datos()
        {
            try
            {
                SqlCommand cmd = new SqlCommand("sp_seleccionarProductos", con);
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
                con.Open();
        ...
        {
            Response.Redirect("CRUDProducto.aspx?op=C");
        }
        protected void Btnread_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("CRUDProducto.aspx?id=" + id + "&op=R");
        }
        ...
        protected void Btnupdate_Click(object sender, EventArgs e)
        {
            ...
            GridViewRow selectedrow = (GridViewRow)btnConsultar.NamingContainer;
            id = selectedrow.Cells[1].Text;
            Response.Redirect("CRUDProducto.aspx?id=" + id + "&op=U");
        }
        ...
        protected void Btndelete_Click(object sender, EventArgs e)
        {
            ...
            GridViewRow selectedrow = (GridViewRow)btnConsultar.NamingContainer;
            id = selectedrow.Cells[1].Text;
            Response.Redirect("CRUDProducto.aspx?id=" + id + "&op=D");
        }
        ...
        protected void Btnhabilitar_Click(object sender, EventArgs e)
        {
            ...
            GridViewRow selectedrow = (GridViewRow)btnConsultar.NamingContainer;
            id = selectedrow.Cells[1].Text;
            Response.Redirect("CRUDProducto.aspx?id=" + id + "&op=H");
        }
        protected void BtnInhabilitados_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("ProductosDeshabilitados", con);
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
                con.Open();
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                ...
                SqlCommand cmd1 = new SqlCommand("ProductosDeshabilitados", con);
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
                con.Open();
