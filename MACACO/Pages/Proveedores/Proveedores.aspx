<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/MP.Master" AutoEventWireup="true" CodeBehind="Proveedores.aspx.cs" Inherits="MACACO.Pages.Proveedores.IndexProveedores" %>
    ...
    <br />  <br />  <br />  
        ...
        <div class="container">
                <div class="row">
                    <div class="col align-self-end">
                        ...
                        <asp:ImageButton runat="server" ID="Btncreate" ImageUrl="~/Imagenes/prov.png" Height="50px" Width="50px" OnClick="Btncreate_Click"/>
                        <asp:ImageButton runat="server" ID="BtnInhabilitados" ImageUrl="~/Imagenes/basura.png" Height="50px" Width="50px" OnClick="BtnUserInhabilitados_Click" />
        ...
        <div class="container row">
            <div class="table small">
                <asp:GridView  runat="server" ID="gvProveedor" class="table table-borderless table-hover fw-bold" ShowFooter="False" SortedAscendingHeaderStyle-HorizontalAlign="Center" SortedAscendingHeaderStyle-VerticalAlign="Middle" SortedAscendingHeaderStyle-BackColor="#66CCFF" HeaderStyle-ForeColor="White" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" HeaderStyle-BackColor="#000099" Font-Bold="True" Font-Italic="False" Font-Size="Medium" RowStyle-HorizontalAlign="Center" RowStyle-VerticalAlign="Middle" Font-Names="Comic Sans MS">
                    <Columns>
